...
window.BACTERIA_RELATED = {
  ...
  // ========== Clostridium / Clostridioides 属 ==========
  cdiff: [
    {
      title: "CDI 治療 — フィダキソマイシン第一選択（IDSA/SHEA 2021）",
      body: "初発 CDI の第一選択はフィダキソマイシン 200 mg q12h × 10 日。バンコマイシン 125 mg q6h は許容代替。メトロニダゾールは推奨されない。再発時は FMT も選択肢。",
      links: [
        { label: "CDI SHEA/IDSA 2021 GL", url: "../articles-gl-cdi-shea2021.html" }
      ]
    },
    {
      title: "原因抗菌薬の中止が予防の鍵",
      body: "CDI と判明したら原因となった抗菌薬を可能な限り速やかに中止する。良好な抗菌薬スチュワードシップが予防の鍵。",
      links: [
        { label: "CDI SHEA/IDSA 2021 GL", url: "../articles-gl-cdi-shea2021.html" }
      ]
    }
  ...
  cperf: [
    {
      title: "ガス壊疽 — PCG ＋ CLDM 併用",
      body: "外傷性ガス壊疽の 80-90% を占める。第一選択はペニシリン G 1,000-2,400 万単位/日 ＋ クリンダマイシン。CLDM は α 毒素・θ 毒素の産生を抑制。外科的デブリードマンが救命の鍵。"
    },
    {
      title: "産後・流産後感染症は劇症型",
      body: "産後・流産後の C. perfringens 感染症はガス壊疽・トキシックショックを伴い死亡率 70-90%。早期の感染源コントロールと抗菌薬が必要。"
    }
  ],

  ctetani: [
    {
      title: "破傷風治療 — メトロニダゾール第一選択 ＋ HTIG 必須",
      body: "メトロニダゾール 500 mg 静注 q6-8h × 7-10 日が第一選択（PCG より副作用プロファイル良好）。抗菌薬は副次的、抗破傷風ヒト免疫グロブリン（HTIG）と創傷の洗浄・デブリードマンが治療の中心。"
    }
  ],

  cbot: [
    {
      title: "ボツリヌス症 — 抗菌薬は原則使用しない",
      body: "ボツリヌス症では抗菌薬は菌の溶解により毒素放出が増加するリスクのため一般的に推奨されない。治療の中心は抗毒素療法（三価ウマ血清抗毒素／乳児はヒト BabyBIG）。48 時間以内の投与で死亡率低下。"
    }
  ],

  csept: [
    {
      title: "C. septicum 菌血症 — 大腸癌の検索が必須",
      body: "C. septicum は他の Clostridium 属より好気耐性が高く、組織損傷がなくても感染を起こす。成人の 50% 以上で消化管悪性腫瘍（特に大腸癌）が背景にあるため、菌血症を見たら大腸癌の検索を行う。"
    },
    {
      title: "自然発症性ガス壊疽 — PCG ＋ CLDM、外科介入が必須",
      body: "C. perfringens によるガス壊疽より予後不良（死亡率 60% 超）。第一選択はペニシリン G ＋ クリンダマイシン。小児生存例の 84% で外科介入があり、早期外科的デブリードマンが救命に直結する。"
    }
  ],

  cacnes: [
    {
      title: "C. acnes — 培養 2 週間以上を依頼",
      body: "肩関節人工関節感染・人工弁感染性心内膜炎・脳室シャント感染の原因。培養に 2 週間以上を要するため、術後早期は培養陰性でも疑い、検査室に長期培養（≥2 週）を依頼する。",
      links: [
        { label: "感染性心内膜炎 板書ノート", url: "../id-icu-notes/note-ie.html" }
      ]
    },
    {
      title: "深部感染症 — PCG／CTRX が第一選択",
      body: "全株がペニシリン G に感受性（MIC ≤0.064 mg/L）。脊椎椎間板炎・心内膜炎・人工関節感染では CTRX 2g 1 日 1 回が外来静注に使いやすい。マクロライド・クリンダマイシンは耐性多数。"
    }
  ],
  ...
  nocardia: [
    {
      title: "ノカルジア症 — ST合剤第一選択、6-12 ヶ月の長期治療",
      body: "感受性率 94-100% で ST合剤（TMP 5-10 mg/kg/日）が第一選択。軽症は単剤 6 ヶ月、重症（播種性・CNS・重症肺）は ST合剤＋イミペネム ／ アミカシン ／ CTRX の多剤併用 6-12 ヶ月。N. farcinica は IPM・CTRX 耐性。",
      links: [
        { label: "発熱性好中球減少症 板書ノート", url: "../id-icu-notes/note-fn.html" }
      ]
    },
    {
      title: "免疫不全患者の空洞性肺病変 — 弱抗酸染色を依頼",
      body: "免疫不全患者で結節・腫瘤影が短期間で空洞化したらノカルジアを疑う。診断には弱抗酸染色（Kinyoun 改良法）を喀痰・気管支洗浄液で依頼する。"
    }
  ],

  actinomyces: [
    {
      title: "アクチノマイコーシス — PCG 高用量、3-6 ヶ月以上",
      body: "ほぼ全菌株が PCG 感受性。ペニシリン G 1,200 万単位/日 静注 × 2-6 週 → アモキシシリン経口に切替、合計 3-6 ヶ月以上。56% が当初悪性腫瘍と誤診されるため、慢性化膿性病変では鑑別に挙げる。",
      links: [
        { label: "腹腔内感染症 板書ノート", url: "../id-icu-notes/note-iai.html" }
      ]
    },
    {
      title: "嫌気性菌だがメトロニダゾール耐性",
      body: "Actinomyces は嫌気性だが MNZ には一様に耐性。経験的な嫌気性カバーで MNZ を選ぶと無効。β-ラクタム・カルバペネム・テトラサイクリン・VCM・LZD には感受性。"
    }
  ],
  ...
  ngon: [
    {
      title: "淋菌治療 — セフトリアキソン IM 単回（CDC 2021）",
      body: "非合併症型はセフトリアキソン 500 mg IM 単回（体重 ≥150 kg は 1 g）。クラミジア未除外なら DOX 100 mg bid × 7 日を併用。AZM との併用療法は CDC 2021 で推奨されなくなった。"
    }
  ],

  nmen: [
    {
      title: "髄膜炎菌性髄膜炎 — CTRX 4g/日（経験的治療）",
      body: "ペニシリン感受性低下株が世界的に増加しているため、経験的治療では CTRX 4 g/日 または CTX 8-12 g/日。感受性確認後はペニシリン G に切替可能。治療期間 7-10 日。",
      links: [
        { label: "髄膜炎 板書ノート", url: "../id-icu-notes/note-meningitis.html" }
      ]
    },
    {
      title: "接触者の予防的化学療法",
      body: "濃厚接触者にはリファンピシン／シプロフロキサシン／セフトリアキソン／ペニシリンによる予防的化学療法を行う。米国ではシプロフロキサシン耐性株が増加（2019-2020）しているため地域の耐性状況を確認。"
    }
  ],
  ...
  moraxella: [
    {
      title: "M. catarrhalis — 90% 以上が β-ラクタマーゼ産生でアンピシリン耐性",
      body: "ABPC・AMPC は 90% 以上が β-ラクタマーゼ産生で耐性。アモキシシリン・クラブラン酸（100%）、第 2/3 世代セフェム、レスピラトリーキノロン、テトラサイクリン系には感受性良好。"
    },
    {
      title: "COPD 急性増悪・小児急性中耳炎の主要起因菌",
      body: "COPD 急性増悪の重要病原体（米国で年間 200-400 万例）。小児急性中耳炎の 15-20% を占める三大起因菌の一つ（S. pneumoniae、H. influenzae と並ぶ）。COPD 急性増悪は 5 日間の短期治療で十分。"
    }
  ],
  ...
  ecoli: [
    {
      title: "市中発症 UTI と敗血症の最多原因菌",
      body: "市中発症 UTI の 75% 以上、市中発症敗血症の最多原因菌。侵襲性大腸菌感染症の 92% が菌血症を伴い、61% が UTI 関連。米国侵襲感染の 34% 以上が 3 剤以上のクラスに耐性。",
      links: [
        { label: "BALANCE：菌血症の治療期間 2025", url: "../articles-gl-balance-bacteremia2025.html" },
        { label: "IDSA 耐性 GNR 治療 2024", url: "../articles-gl-idsa-amr-gnr2024.html" }
      ]
    },
    {
      title: "ESBL 菌血症 — メロペネム第一選択（MERINO 試験）",
      body: "MERINO 試験：CTRX 耐性 E. coli/K. pneumoniae 菌血症で MEPM はピペラシリン・タゾバクタムより 30 日死亡率低下（4% vs 12%）。ESBL 重症感染にはカルバペネム第一選択。",
      links: [
        { label: "IDSA 耐性 GNR 治療 2024", url: "../articles-gl-idsa-amr-gnr2024.html" }
      ]
    }
  ...
  kpneu: [
    {
      title: "古典型（cKp）と高病原性型（hvKp）の臨床像が異なる",
      body: "cKp は院内感染（肺炎・UTI・血流感染）で、hvKp は健常者の化膿性肝膿瘍・眼内炎・髄膜炎・転移性感染を起こす。hvKp は東アジア・台湾で多く、K1（33%）／K2（21%）莢膜型が中心。"
    },
    {
      title: "CRE — KPC 産生株は新規 BL/BLI 配合剤が第一選択",
      body: "KPC 産生 CRE は メロペネム・バボルバクタム（JP未承認）／セフタジジム・アビバクタム／イミペネム・シラスタチン・レレバクタム（JP未承認）のいずれかが第一選択（95% 以上の活性）。NDM 産生はセフィデロコール または CAZ-AVI ＋ アズトレオナム併用。",
      links: [
        { label: "IDSA 耐性 GNR 治療 2024", url: "../articles-gl-idsa-amr-gnr2024.html" }
      ]
    }
  ...
  koxy: [
    {
      title: "AAHC（抗菌薬関連出血性大腸炎） — ペニシリン系投与後",
      body: "K. oxytoca 細胞毒素（tilivalline・tilimycin）産生株がペニシリン系投与後に腸管内で過増殖し、右側結腸の出血性大腸炎を起こす。原因抗菌薬の中止が最重要、3 日以内に症状改善する。"
    },
    {
      title: "固有 β-ラクタマーゼ blaOXY を保有",
      body: "K. oxytoca complex は染色体性 β-ラクタマーゼ blaOXY を保有。SENTRY データでカルバペネム非感受性 1.8%、CTRX 12.5%、CPFX 7.1%、コリスチン 0.8%。ESBL・KPC-2 産生株が増加傾向。"
    }
  ],

  enterobacter: [
    {
      title: "AmpC 産生菌 — セフェピム第一選択、CTRX/CTX/CAZ 回避",
      body: "染色体性 AmpC β-ラクタマーゼ産生のため、CTRX/CTX/CAZ は感受性があっても治療中の AmpC 過剰産生による耐性化（約 20%）リスクで回避。第一選択はセフェピムまたはカルバペネム。",
      links: [
        { label: "IDSA 耐性 GNR 治療 2024", url: "../articles-gl-idsa-amr-gnr2024.html" }
      ]
    },
    {
      title: "VAP・血流感染の重要起因菌",
      body: "ECC（Enterobacter cloacae complex）は ICU・新生児 ICU での血流感染（37%）・呼吸器感染（VAP・院内肺炎、16-26%）の重要病原体。血流感染の院内死亡率 約 52%。",
      links: [
        { label: "VAP 板書ノート", url: "../id-icu-notes/note-vap.html" }
      ]
    }
  ],
  ...
  kaero: [
    {
      title: "K. aerogenes — 旧 Enterobacter aerogenes、AmpC 産生",
      body: "旧 Enterobacter aerogenes。染色体性 AmpC β-ラクタマーゼの誘導性過剰産生で、Enterobacter cloacae complex と同様の治療戦略（セフェピム or カルバペネム）が推奨される。ICU でアウトブレイクの原因となる。",
      links: [
        { label: "IDSA 耐性 GNR 治療 2024", url: "../articles-gl-idsa-amr-gnr2024.html" }
      ]
    }
  ...
  citrobacter: [
    {
      title: "C. freundii complex — AmpC 産生菌として治療",
      body: "Enterobacter cloacae complex や Klebsiella aerogenes と同じ治療戦略。CTRX/CTX/CAZ は AmpC 誘導による耐性化リスクで回避し、セフェピムまたはカルバペネムを選択。",
      links: [
        { label: "IDSA 耐性 GNR 治療 2024", url: "../articles-gl-idsa-amr-gnr2024.html" }
      ]
    }
  ...
  ckoseri: [
    {
      title: "新生児髄膜炎・脳膿瘍 — メロペネム第一選択",
      body: "C. koseri は新生児髄膜炎の原因菌として知られ、約 76% で脳膿瘍を形成。死亡率 30%、生存者の半数以上に CNS 障害が残る。CNS 移行性と細胞内殺菌能のためメロペネムが第一選択（従来の第3世代セフェム＋アミノグリコシドより予後良好）。治療期間 21 日以上。",
      links: [
        { label: "髄膜炎 板書ノート", url: "../id-icu-notes/note-meningitis.html" }
      ]
    }
  ...
  proteus: [
    {
      title: "P. mirabilis — ストルバイト結石形成と CAUTI",
      body: "ウレアーゼ産生で尿アルカリ化し、感染性結石（ストルバイト・サンゴ状結石）を形成。長期カテーテル留置患者での CAUTI で重要。テトラサイクリン・ニトロフラントイン自然耐性。"
    },
    {
      title: "ESBL 菌血症 — カルバペネム第一選択、IPM は耐性高",
      body: "ESBL 産生株では MEPM・ドリペネム・ERTM が第一選択。<strong>イミペネムは耐性率 47-55% と高く推奨されない</strong>。ピペラシリン・タゾバクタムは MIC ≤0.5/4 mg/L の場合のみ使用可。"
    }
  ],

  pvulg: [
    {
      title: "P. vulgaris — アンピシリン・第1世代セフェム自然耐性",
      body: "染色体性誘導型 β-ラクタマーゼを産生し、アンピシリン・第1世代セファロスポリンに自然耐性。ESBL 産生株にはカルバペネム系が第一選択。"
    }
  ],

  morgan: [
    {
      title: "AmpC 産生菌、コリスチン自然耐性",
      body: "染色体性 AmpC β-ラクタマーゼ産生で第1世代セフェム・アンピシリン・クラブラン酸に自然耐性。コリスチンも自然耐性。軽症は PIPC/TAZ・セフェピム、重症はカルバペネム第一選択。",
      links: [
        { label: "IDSA 耐性 GNR 治療 2024", url: "../articles-gl-idsa-amr-gnr2024.html" }
      ]
    }
  ...
  styphi: [
    {
      title: "腸チフス — 渡航地域別の経験的治療",
      body: "パキスタン・イラク渡航歴ありはアジスロマイシン（軽症）またはカルバペネム（重症）— XDR 株対策。その他の地域は CTRX または AZM。南アジア渡航者でフルオロキノロン非感受性 85% 以上のため CPFX は推奨されない。"
    }
  ],

  sparat: [
    {
      title: "S. Paratyphi は S. Typhi と異なり第一選択薬感受性を維持",
      body: "S. Paratyphi A/B/C は ABPC・CHL・ST合剤への感受性を維持（97-100%）し、MDR はほぼ認めない。CTRX 耐性報告なし。シプロフロキサシン非感受性は 99% 以上で推奨されない。"
    }
  ],
  ...
  paerug: [
    {
      title: "緑膿菌 — DTR-Pa は新規 BL/BLI 配合剤を選択",
      body: "感受性株（MDR でない）は従来の β-ラクタム（PIPC/TAZ・CAZ・CFPM・MEPM）を優先。DTR-Pa（Difficult-to-Treat Resistance）はセフトロザン・タゾバクタム／セフタジジム・アビバクタム／イミペネム・シラスタチン・レレバクタム（JP未承認）が第一選択、セフィデロコールが代替。",
      links: [
        { label: "IDSA 耐性 GNR 治療 2024", url: "../articles-gl-idsa-amr-gnr2024.html" },
        { label: "VAP 板書ノート", url: "../id-icu-notes/note-vap.html" }
      ]
    ...
    {
      title: "VAP・FN の重要起因菌、本質的に多剤耐性",
      body: "ICU 感染症の最大 23%、VAP の主要起因菌（死亡率 32-43%）。発熱性好中球減少症の経験的カバーが必須。本質的に多剤耐性で治療中にさらなる耐性を獲得しうる。",
      links: [
        { label: "発熱性好中球減少症 板書ノート", url: "../id-icu-notes/note-fn.html" }
      ]
    }
  ...
  acinetobacter: [
    {
      title: "CRAB — スルバクタム含有レジメン＋カルバペネム併用（IDSA 2024）",
      body: "CRAB は少なくとも 2 剤の併用療法を行い、少なくとも 1 剤はスルバクタム含有とする。推奨は スルバクタム・デュロバクタム（JP未承認）＋カルバペネム。代替は高用量 ABPC/SBT（スルバクタム成分 9 g/日）＋ ポリミキシン B / ミノサイクリン / チゲサイクリン / セフィデロコール。",
      links: [
        { label: "IDSA 耐性 GNR 治療 2024", url: "../articles-gl-idsa-amr-gnr2024.html" },
        { label: "VAP 板書ノート", url: "../id-icu-notes/note-vap.html" }
      ]
    ...
    {
      title: "WHO 最優先病原体、ICU 機器で長期生存",
      body: "WHO 最優先病原体に指定。乾燥に強く ICU 機器・手指で数週間生存可能で院内伝播を促進。MDR 株死亡率 30-75%、XDR 株最大 70%。"
    }
  ],

  bcepacia: [
    {
      title: "B. cepacia complex — 嚢胞性線維症（CF）の慢性肺感染",
      body: "CF 患者の 2-4% が感染。cepacia syndrome（敗血症＋壊死性肺炎）は急速進行で早期死亡に至り、B. cenocepacia 感染は肺移植の除外基準とされる。第一選択は ST合剤（感受性 82-95%）、代替に MEPM・CAZ・CAZ-AVI など。"
    },
    {
      title: "ポリミキシン・コリスチンに固有耐性",
      body: "BCC はポリミキシン・コリスチンに固有耐性。多くの β-ラクタムにも耐性で、感受性試験は broth microdilution 法のみ推奨（disk diffusion・ETEST は信頼性低い）。"
    }
  ],

  bpseudo: [
    {
      title: "類鼻疽（melioidosis） — 2 段階療法",
      body: "東南アジア・北豪の風土病。第 1 段階：集中治療期（CAZ または MEPM/IPM 静注 ≥10-14 日）→ 第 2 段階：根絶治療期（ST合剤単独 経口 3-6 ヶ月）。糖尿病が最大のリスク因子で致命率 10-50%。"
    }
  ]
